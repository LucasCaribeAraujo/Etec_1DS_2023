...
public class Exercicio04 {
	...
	public static void main(String[] args) {
		...
		//COLOCAR VALORES NA MATRIZ (nota: os numeros n�o s�o repetidos)
		int contadorLinha=0;
		...
		while(true) {
			System.out.println("Informe o N�mera da Sorte hahahaha");
			...
			if(existeNoVetor) {
				...
				System.out.println("Parabens, este numero est� na cartela, faltam " + contadorAle + " numeros");
			} else {
				System.out.println("Voc� errou hahahhahaha, tente novamente");
			}
			...
			if(contadorPontos == 16) {
				System.out.println("Parabens! voc� venceu hahaha, levou " + contadorRodadas + " rodadas");
				break;
			}
		}
